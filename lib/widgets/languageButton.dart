            ...
            showMenu<String>(
              ...
              items: [
                ...
                PopupMenuItem<String>(
                    ...
                    value: '1'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("CHINESE"),
                        style: const TextStyle(color: Colors.white)),
                    value: '2'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("SPANISH"),
                        style: const TextStyle(color: Colors.white)),
                    value: '3'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("ARABIC"),
                        style: const TextStyle(color: Colors.white)),
                    value: '4'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("RUSSIAN"),
                        style: const TextStyle(color: Colors.white)),
                    value: '5'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("JAPANESE"),
                        style: const TextStyle(color: Colors.white)),
                    value: '6'),
                PopupMenuItem<String>(
                    child: Text(DemoLocalization.of(context).translate("DEUTCH"),
                        style: const TextStyle(color: Colors.white)),
                    value: '7'),
              ],
              elevation: 7.0,
