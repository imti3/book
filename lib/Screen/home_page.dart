        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          if (snapshot.hasData) {
            return GridView.builder(
              ...
              key: PageStorageKey<String>('home_${snapshot.data.length}'),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Image.asset(
                            "assets/images/container_box3.png",
                          ),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            crossAxisAlignment: CrossAxisAlignment.center,
...
class GlobalBottomNavigationBar extends StatefulWidget {
  @override
  _GlobalBottomNavigationBarState createState() => _GlobalBottomNavigationBarState();
}
...
class _GlobalBottomNavigationBarState extends State<GlobalBottomNavigationBar> {
  ...
  void initState() {
    ...
    _bannerAd.load();
    //_bannerAd=AdmobService.showBannerAd();
  }
  ...
  @override
  void dispose() {
    _bannerAd.dispose();  // Dispose of the ad when not needed
    super.dispose();
  }
}
