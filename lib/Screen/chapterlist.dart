                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: dark_mode ? ColorsRes.white : ColorsRes.grey1, //grey1
                              ),
                              child: Column(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 25,
                                                color:
                                                dark_mode ? ColorsRes.appColor : ColorsRes.white,
                                                fontFamily: "Poppins",
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            "${chapter_total} " +
                                                DemoLocalization.of(context).translate("Chapters"),
                                            style: TextStyle(
                                                color: dark_mode
                                                    ? ColorsRes.appColor
                                                    : ColorsRes.white),
                            ...
                            Positioned.directional(
                              ...
                              child: Stack(
                                children: [
                                  Image.asset(
                                    "assets/images/book_container2.png",
                                  ),
                                  Positioned(
                                    top: 0,
                                    left: 0,
                            ...
                            FutureBuilder(
                              ...
                              builder: (context, index) {
                                ...
                                return ListView.builder(
                                  key: PageStorageKey<String>('home2_$Last_Chapter'),
                                                ...
                                                Expanded(
                                                  child: Text(
                                                      ...
                                                      if (Language_flag == "en") {
                                                        ...
                                                        return item.hi_Short_Description!;
                                                      } else if (Language_flag == "zh") {
                                                        return item.zh_Short_Description!;
                                                      } else if (Language_flag == "es") {
                                                        return item.es_Short_Description!;
                                                      } else if (Language_flag == "ar") {
                                                        return item.ar_Short_Description!;
                                                      } else if (Language_flag == "ru") {
                                                        return item.ru_Short_Description!;
                                                      } else if (Language_flag == "ja") {
                                                        return item.ja_Short_Description!;
                                                      } else if (Language_flag == "de") {
                                                        return item.de_Short_Description!;
                                                      } else {
                                                        return item.Short_Description!;
                                                      }
                                                    }(),
